...
public final class CuckooHashMap<K, V> extends AbstractMap<K, V> {
    ...
    private static final int kStartSize = 40;

    /* The maximum load factor, which we arbitrarily set it%. */
    private static final float kMaxLoadFactor = 0.1f;
	...
	public static void main(String[] args) {
		...
		System.out.println("Total Time taken for the program " +totalTime);
		System.out.println("Total Memory usage of the program is " +actualMemUsed);
	}
}
